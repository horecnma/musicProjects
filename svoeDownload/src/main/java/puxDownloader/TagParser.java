...
//		try(InputStream input = new URL(url).openStream())
	...
	private static Metadata parse(File fileLocation) throws TikaException, SAXException, IOException
	{
	...
	private static void print(File file) throws IOException, TikaException, SAXException
	{
